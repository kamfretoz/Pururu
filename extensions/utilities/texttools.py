...
@texttools.child
@lightbulb.option("text", "The text you want to drunkify", hikari.OptionType.STRING, required=True)
...
@texttools.child
@lightbulb.option("gap", "The gap between each T E X T", hikari.OptionType.INTEGER, min_value = 1, max_value = 5)
@lightbulb.option("text", "The text you want to reverse", hikari.OptionType.STRING, required=True)

...
@lightbulb.option("colour_codes", "HEX Code for the color", type = str, required = True, modifier = lightbulb.commands.OptionModifier.CONSUME_REST)
@lightbulb.command("color", "Posts color of given hex code", aliases=["getcolor", "colour", "getcolour"])
@lightbulb.implements(lightbulb.SlashCommand, lightbulb.PrefixCommand)
@filament.utils.pass_options
async def color(ctx: lightbulb.Context, colour_codes):
